...
export function ApiDocsContent() {
  ...
  return (
    <div className="container mx-auto space-y-8 p-6 lg:p-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{t('apiDocs.title')}</h1>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <CardTitle>{t('apiDocs.gettingStarted')}</CardTitle>
          </div>
          <CardDescription>{t('apiDocs.gettingStartedSubtitle')}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div>
            <h3 className="font-semibold mb-2">{t('apiDocs.authentication')}</h3>
  ...
  -H "Content-Type: application/json"`}
          ...
          <div>
            <h3 className="font-semibold mb-2">{t('apiDocs.responseFormat')}</h3>
            <p className="text-sm text-muted-foreground mb-2">
              {t('apiDocs.responseFormatDescription')}
            </p>
  ...
  "error": null
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('apiDocs.endpointsSubtitle')}</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('apiDocs.codeExamples')}</CardTitle>
          <CardDescription>{t('apiDocs.codeExamplesSubtitle')}</CardDescription>
        </CardHeader>
    ...
    "description": "Project description"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('apiDocs.rateLimitsSubtitle')}</CardDescription>
        </CardHeader>
        <CardContent>

...
export const NavBar = () => {
  ...
  return (
    <Navbar isBordered maxWidth="full" className="shadow-sm" aria-label={t.accessibility?.mainNavigation || 'Main navigation'}>
      <NavbarBrand aria-label={t.accessibility?.applicationLogo || 'Pressograph application logo'}>
      ...
      <NavbarContent className="hidden sm:flex gap-3" justify="end">
        ...
        <NavbarItem>
          <Button
            ...
            variant="flat"
            size="sm"
            aria-label={t.accessibility?.ctrlHHelp || 'Press Ctrl+H for help'}
            startContent={
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
export const ru: TranslationKeys = {
  ...
  helpGettingStartedIntro: 'Добро пожаловать в Pressograph! Это руководство поможет вам начать создавать профессиональные графики испытаний давления.',
  helpQuickOverview: 'Краткий обзор',
  helpQuickOverviewText: 'Pressograph — это профессиональный инструмент для генерации, визуализации и экспорта графиков испытаний давления. Поддерживает множество форматов экспорта (PNG, PDF, JSON), предоставляет настраиваемые параметры испытаний и предлагает светлую и темную темы.',
  ...
  helpTestConfigIntro: 'Понимание параметров испытания необходимо для точной документации испытаний давления. Каждый параметр влияет на то, как генерируется и отображается график.',
  helpTestNumberDesc: 'Уникальный идентификатор испытания давления. Используйте последовательную систему именования (например, 2024-001, ТЕСТ-А-001).',
  helpTestNumberRange: 'Любая буквенно-цифровая строка (рекомендуется: до 20 символов)',
  helpTemperatureDesc: 'Температура окружающей среды во время испытания давлением. Важна для точной документации и анализа.',
  helpTemperatureRange: 'Типичный диапазон: от -50°C до 100°C',
  helpGraphTitleDesc: 'Пользовательский заголовок, отображаемый вверху графика. Используйте описательные названия для легкой идентификации.',
  ...
  helpWorkingPressureDesc: 'Нормальное рабочее давление тестируемой системы. Используется как опорная линия на графике.',
  helpWorkingPressureRange: 'Типичный диапазон: от 0.1 до 10.0 МПа',
  helpMaxPressureDesc: 'Максимальное давление, достигнутое во время испытания. Обычно в 1.5 раза больше рабочего давления для испытаний безопасности.',
  ...
  helpGraphInterpretIntro: 'Узнайте, как читать и интерпретировать графики испытаний давления, созданные Pressograph.',
  helpReadingCurveTitle: 'Чтение кривой давления',
  helpReadingCurveText: 'Кривая давления показывает, как давление изменяется со временем. Ось X представляет время (в часах), а ось Y представляет давление (в МПа). Ищите плавные переходы и стабильные плато в периоды удержания.',
  helpStagesTitle: 'Понимание стадий испытания',
  helpStageHold: 'Стадия удержания',
  helpStageHoldDesc: 'Система поддерживает постоянное давление для обнаружения утечек. Давление должно оставаться стабильным с минимальным дрейфом.',
  helpStageDrop: 'Стадия падения давления',
  helpStageDropDesc: 'Контролируемое снижение давления для измерения восстановления системы. Отслеживает, как давление уменьшается со временем.',
  helpStageDrain: 'Стадия слива',
  helpStageDrainDesc: 'Окончательная разгерметизация системы. Давление возвращается к атмосферному уровню.',
  helpPassFailTitle: 'Критерии прохождения/отказа',
  helpPassFailText: 'Испытания давлением оцениваются на основе пределов падения давления и требований ко времени удержания:',
  helpPassCriteria: 'Критерии прохождения',
  helpPassCriteriaText: 'Падение давления остается в допустимых пределах в периоды удержания. Система сохраняет стабильность.',
  helpFailCriteria: 'Критерии отказа',
  helpFailCriteriaText: 'Чрезмерное падение давления указывает на утечки или отказ системы. Требуется расследование и ремонт.',
  ...
  helpExportIntro: 'Pressograph поддерживает множество форматов экспорта для различных случаев использования.',
  ...
  helpExportJSONDesc: 'Сохранение полной конфигурации испытания в формате JSON для резервного копирования или повторного использования.',
  helpPerformanceTipsTitle: 'Советы по производительности',
  helpPerformanceTip1: 'Используйте умеренные размеры для более быстрого экспорта (например, 1920×1080 вместо 4K)',
  helpPerformanceTip2: 'Экспорт PDF может занять больше времени для сложных графиков с большим количеством точек данных',
  helpPerformanceTip3: 'Экспорт JSON мгновенный и рекомендуется для резервного копирования конфигураций',
  helpPerformanceTip4: 'Закройте другие вкладки браузера для оптимальной производительности во время экспорта',

  // FAQ Section
  helpFAQTitle: 'Часто задаваемые вопросы',
  helpFAQ1Q: 'Какова рекомендуемая длительность испытания?',
  helpFAQ1A: 'Стандартные испытания давлением обычно длятся 24 часа. Расширенные испытания могут длиться 48-72 часа. Короткие испытания (4-8 часов) используются для быстрой проверки.',
  helpFAQ2Q: 'Как добавить промежуточные испытания давлением?',
  helpFAQ2A: 'На главной странице прокрутите до раздела "Промежуточные испытания давлением" и нажмите "Добавить испытание". Настройте время, длительность и опциональные параметры давления для каждого промежуточного испытания.',
  helpFAQ3Q: 'Могу ли я импортировать предыдущие конфигурации испытаний?',
  helpFAQ3A: 'Да! Экспортируйте испытание в формате JSON, затем используйте кнопку "Импорт JSON" для загрузки конфигурации в будущей сессии.',
  helpFAQ4Q: 'Какие браузеры поддерживаются?',
  helpFAQ4A: 'Pressograph лучше всего работает на современных браузерах: Chrome 90+, Firefox 88+, Safari 14+, Edge 90+. Требуется поддержка Canvas API для отрисовки графиков.',
  helpFAQ5Q: 'Почему мой экспорт занимает много времени?',
  helpFAQ5A: 'Большие размеры (4K+) или сложные графики с множеством промежуточных испытаний могут замедлить экспорт. Попробуйте уменьшить размеры или закрыть другие вкладки.',
  helpFAQ6Q: 'Как переключаться между светлой и темной темами?',
  helpFAQ6A: 'Нажмите кнопку переключения темы в панели навигации или используйте комбинацию клавиш Ctrl+T (Cmd+T на Mac).',
  helpFAQ7Q: 'Могу ли я поделиться графиками с другими?',
  helpFAQ7A: 'Да! Экспортируйте как PNG или PDF для обмена по электронной почте или в документах. JSON-файлы можно делиться с другими пользователями Pressograph для репликации точной конфигурации.',
  helpFAQ8Q: 'Где хранятся данные моих испытаний?',
  helpFAQ8A: 'Данные испытаний хранятся в базе данных приложения. Экспортируйте JSON-файлы для локальных резервных копий. Администраторы могут настроить политики резервного копирования.',
